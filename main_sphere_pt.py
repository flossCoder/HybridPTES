...
# 
# main_sphere_pt.py is free software: you can redistribute it and/or modify it
# under the terms of the GNU General Public License as published by the
# Free Software Foundation, either version 3 of the License, or
# (at your option) any later version.
# 
# main_sphere_pt.py is distributed in the hope that it will be useful, but
...
tempArray = [0.1, 0.3, 0.5, 0.7, 1.0, 1.5]
